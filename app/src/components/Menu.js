...
import logo from "../assets/grape_icon.png"
        ...
        <div>
            ...
            <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800 pr-40">
                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <a href="/goals" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
